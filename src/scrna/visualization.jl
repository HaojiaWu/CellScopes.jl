function dim_plot(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject,scATACObject, MerfishObject, SlideseqObject}; anno::Union{Symbol, String}="cluster", dim_type::String="umap",
...
function highlight_cells(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}, cl::String; dim_type="umap", anno::Union{String,Symbol}="cluster",
...
function feature_plot(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}, genes; dim_type::String = "umap", count_type = "norm",x_lims=nothing, y_lims=nothing, marker_size=4, order=true,
...
function dot_plot(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}, genes::Union{Vector, String},
...
function violin_plot(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}, genes; 
