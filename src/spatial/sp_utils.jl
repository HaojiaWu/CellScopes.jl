...
function compute_pearson_cor(sp::Union{CartanaObject, XeniumObject, MerfishObject, seqFishObject, starMapObject}, cluster1::Union{Symbol, String}, cluster2::Union{Symbol, String}; color_scheme::String="lightgreyred",reverse_color::Bool=false)
...
function subset_fov(sp::Union{CartanaObject, XeniumObject,MerfishObject, seqFishObject, starMapObject}, fov::Vector{Int64}, n_fields_x::Int64, n_fields_y::Int64)
    df=sp.spmetaData.cell
...
function compute_kidney_coordinates(sp::Union{CartanaObject, XeniumObject, MerfishObject, seqFishObject, starMapObject}, center)
    df = sp.spmetaData.cell
    kid_depth=[]
    kid_angle=[]
    n=length(df.x)
...
function visium_deconvolution(vs::Union{VisiumObject, SlideseqObject}, sp::Union{CartanaObject, XeniumObject, MerfishObject, seqFishObject, starMapObject}, spot_r::Union{Int64, Float64};
...
function bin_gene_spatial(sp::Union{CartanaObject, XeniumObject,MerfishObject, seqFishObject, starMapObject}, n_bin::Int64; 
