...
rownames(sc_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject,  CartanaObject, XeniumObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject}) = sc_obj.rawCount.gene_name
rownames(sc_obj::scATACObject) = sc_obj.rawCount.peak_name
colnames(sc_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject}) = sc_obj.rawCount.cell_name
...
function extract_cluster_count(sc_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject}, cl; count_type = "norm", anno = Union{String, Symbol}="cluster")
...
function variable_genes(sc_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject})
    vargenes = pbmc.varGene.var_gene
    return vargenes
end

function update_object(sp_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject})
    ...
    if isa(sp_obj, Union{ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject})
...
function subset_object(sp_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject}; cells = nothing, genes = nothing)
...
function update_count(sp_obj::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject}, ct_name::Union{Symbol, String})
...
function annotate_cells(sp::Union{scRNAObject, VisiumObject, ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, SlideseqObject, seqFishObject, STARmapObject, StereoSeqObject, CosMxObject}, cell_map::Dict; old_id_name::Union{String, Symbol}="cluster", new_id_name::Union{String, Symbol}="celltype")
