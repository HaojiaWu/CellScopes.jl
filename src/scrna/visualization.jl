function dim_plot(sc_obj::get_object_group("All"); anno::Union{Symbol, String}="cluster", dim_type::String="umap",
...
function violin_plot(sc_obj::get_object_group("All"), genes; 
