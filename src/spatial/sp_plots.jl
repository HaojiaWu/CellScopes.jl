...
function sp_dot_plot(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject, XeniumObject, MerfishObject, SlideseqObject, STARmapObject, seqFishObject, StereoSeqObject}, genes::Union{Vector, String},
...
#=
function sp_feature_plot(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject, XeniumObject,MerfishObject, SlideseqObject, STARmapObject, seqFishObject, StereoSeqObject}, gene_list::Union{String, Vector{String}, Tuple{String}}; layer::String = "cells", x_col::Union{String, Symbol}="x",
        ...
        for (i, gene) in enumerate(gene_list)
            ...
            if custom_img
                if isa(sp, XeniumObject)
                    ...
                    if !isa(x_lims, Nothing) && !isa(y_lims, Nothing)
                        xlims_sub = round.(Int, xlims) 
                        ylims_sub = round.(Int, ylims) 
                        img = img[xlims_sub[1]:xlims_sub[2], ylims_sub[1]:ylims_sub[2]]
                    end
                    img2 = augment(img, ColorJitter(adjust_contrast, adjust_brightness))
                    MK.image!(ax1, img2)
                end
...
function plot_gene_polygons(sp::Union{ImagingSpatialObject, CartanaObject,XeniumObject,MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}, gene_list::Union{String, Vector{String}, Tuple{String}};
...
function plot_transcript_polygons(sp::Union{ImagingSpatialObject, CartanaObject,XeniumObject,MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}; 
...
function sp_highlight_cells(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject,XeniumObject,MerfishObject, SlideseqObject, STARmapObject, seqFishObject, StereoSeqObject}, cell_hightlight::String, anno::Union{String,Symbol};
...
function sp_gene_rank(sp::Union{ImagingSpatialObject, CartanaObject, XeniumObject, MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}, celltype::String, cluster::String; num_gene::Int64=20)
...
function sp_feature_plot_group(sp_list::Union{ Vector{ImagingSpatialObject}, Vector{CartanaObject}, Vector{XeniumObject}, Vector{VisiumObject}, Vector{MerfishObject}, Vector{SlideseqObject}, Vector{seqFishObject}, Vector{STARmapObject}, Vector{StereoSeqObject}}, genes::Vector{String};
...
function plot_point(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject, XeniumObject,MerfishObject, SlideseqObject, STARmapObject, seqFishObject, StereoSeqObject}, pt::Vector{Float64}; 
...
function plot_depth(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject, XeniumObject,MerfishObject, SlideseqObject, seqFishObject, StereoSeqObject}; celltype::Union{String, Symbol} = :celltype,
...
function plot_depth_animation(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject, XeniumObject,MerfishObject, SlideseqObject, STARmapObject, seqFishObject, StereoSeqObject}, celltypes::Vector{String}, markers::Vector{String}; 
...
function plot_gene_depth(sp::Union{ImagingSpatialObject, CartanaObject, VisiumObject, XeniumObject,MerfishObject, SlideseqObject, STARmapObject, seqFishObject, StereoSeqObject}, gene::String;
...
function PlotInteractive(sp::Union{CartanaObject, VisiumObject, XeniumObject,MerfishObject, SlideseqObject, seqFishObject, StereoSeqObject}; layer::String = "cells", marker_color::Union{Symbol, String}="black", marker_size=3, plot_mode="markers")
    if layer === "cells"
        cells=sp.spmetaData.cell
...
function plot_transcript_dapi(sp::Union{ImagingSpatialObject, CartanaObject,XeniumObject,MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}, fov::Int64, n_fields_x::Int64, 
...
function compare_gene_imputation(sp1::Union{ImagingSpatialObject, CartanaObject,XeniumObject, MerfishObject, STARmapObject, seqFishObject, StereoSeqObject},sp2::Union{CartanaObject,XeniumObject,MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}, gene_list::Union{Vector, String},
...
function plot_heatmap(sp::Union{ImagingSpatialObject, CartanaObject,XeniumObject, MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}, gene_list::Union{Vector, String},
...
function overlay_visium_cartana(vs::Union{VisiumObject, SlideseqObject}, sp::Union{ImagingSpatialObject, CartanaObject,XeniumObject,MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}; vs_x = "new_x", vs_y = "new_y", 
...
function overlay_visium_cartana_gene(vs::Union{VisiumObject, SlideseqObject}, sp::Union{ImagingSpatialObject, CartanaObject,XeniumObject, MerfishObject, STARmapObject, seqFishObject, StereoSeqObject}, gene; vs_x="new_x", vs_y="new_y", sp_x="new_x", sp_y="new_y",
...
function plot_gene_group_spatial(sp_list::Union{Vector{ImagingSpatialObject}, Vector{CartanaObject},Vector{XeniumObject}, Vector{MerfishObject}, Vector{SlideseqObject}, Vector{seqFishObject}, Vector{STARmapObject}, Vector{StereoSeqObject}}, n_bin, gene_list; group_names::Union{Vector, String, Nothing}=nothing,
