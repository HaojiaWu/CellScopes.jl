...
function scale_object(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject,MerfishObject, SlideseqObject}; features::Union{Vector{String}, Nothing}=nothing, scale_max = 10.0, do_scale::Bool = true, do_center::Bool = true)
...
function find_variable_genes(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject,MerfishObject, SlideseqObject}; nFeatures::Int64 = 2000, span::Float64 = 0.3)
...
function run_pca(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject,MerfishObject, SlideseqObject}; method=:svd, pratio = 1, maxoutdim = 10)
...
function run_clustering_atlas(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject,MerfishObject, SlideseqObject}; n_neighbors=30, metric=CosineDist(), res= 0.06, seed_use=1234)
...
function run_clustering_small(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}; n_neighbors=30, metric=CosineDist(), res= 0.06, seed_use=1234)
...
function run_clustering(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}; n_neighbors=30, metric=CosineDist(), res= 0.06, seed_use=1234)
...
function run_tsne(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}; ndim::Int64 = 2, dims_use = 1:10, max_iter::Int64 = 2000, perplexit::Real = 30.0, pca_init::Bool = true,  seed_use::Int64 = 1234)
    Random.seed!(seed_use)
...
function run_umap(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject,MerfishObject, SlideseqObject}; ndim::Int64 = 2, dims_use = 1:10, n_neighbors::Int64 = 30, n_epochs=300, init = :spectral, metric = CosineDist(), min_dist::Real = 0.4, seed_use::Int64 = 1234)
    Random.seed!(seed_use)
    pca_mat = sc_obj.dimReduction.pca.cell_embedding
    pca_mat = pca_mat[:, dims_use]
...
function find_markers(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject, MerfishObject, SlideseqObject}; cluster_1::Union{String, Nothing}=nothing, cluster_2::Union{String, Nothing}=nothing, 
...
function find_all_markers(sc_obj::Union{scRNAObject, VisiumObject, CartanaObject, XeniumObject, scATACObject,MerfishObject, SlideseqObject}; anno::Union{String, Symbol}="cluster", expr_cutoff=0.0, min_pct=0.1, p_cutoff = 0.05, only_pos = true)
    if isa(anno, String)
        anno = Symbol(anno)
    end
